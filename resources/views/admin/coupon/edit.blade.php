                ...
                <div class="col-md-12">
                    <form action="{{ route('coupons.update' , $coupon->id) }}" method="POST" autocomplete="off" id="coupon_create_form">
                        ...
                        <div class="form-group">
                            ...
                            <p class="text-danger" id="error_coupon_name"></p>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <p class="text-danger" id="error_coupon_code"></p>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <p class="text-danger" id="error_coupon_quantity"></p>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control datepicker" id="start_date_coupon"
                                        name="start_date" value="{{ $coupon->start_date }}" placeholder="yyyy-mm-dd">
                                    <p class="text-danger" id="error_coupon_start_date"></p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>End Date</label>
                                    <input type="text" class="form-control datepicker" id="end_date_coupon"
                                        name="end_date" value="{{ $coupon->end_date }}" placeholder="yyyy-mm-dd">
                                    <p class="text-danger" id="error_coupon_end_date"></p>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <p class="text-danger" id="error_coupon_discount"></p>
                                </div>
                            </div>
                        </div>
