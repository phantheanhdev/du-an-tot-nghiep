...
@section('main-content')
            ...
            <div class="col-3">
                <a href="search-list.html" class="text-decoration-none">
                    <div class="card border-0">
                        ...
                        <div class="card-body text-center px-0 pb-0">
                            <h6 class="card-title text-muted m-0">Sweets</h6>
                        </div>
                    </div>
                </a>
            </div>
            <div class="col-3">
                <a href="search-list.html" class="text-decoration-none">
                    <div class="card border-0">
                        ...
                        <div class="card-body text-center px-0 pb-0">
                            <h6 class="card-title text-muted m-0">Burger</h6>
                        </div>
                    </div>
                </a>
            </div>
            <div class="col-3">
                <a href="search-list.html" class="text-decoration-none link-dark">
                    <div class="card border-0">
                        ...
                        <div class="card-body text-center px-0 pb-0">
                            <h6 class="card-title text-muted m-0">Pizza</h6>
                        </div>
                    </div>
                </a>
            </div>
            <div class="col-3">
                <a href="search-list.html" class="text-decoration-none">
                    <div class="card border-0">
                        ...
                        <div class="card-body text-center px-0 pb-0">
                            <h6 class="card-title text-muted m-0">Noddles</h6>
                        </div>
                    </div>
                </a>
            </div>
            ...
            <div class="col-3">
                <a href="search-list.html" class="text-decoration-none">
                    <div class="card border-0">
                        ...
                        <div class="card-body text-center px-0 pb-0">
                            <h6 class="card-title text-muted m-0">Rolls</h6>
                        </div>
                    </div>
                </a>
            </div>
            <div class="col-3">
                <a href="search-list.html" class="text-decoration-none">
                    <div class="card border-0">
                        ...
                        <div class="card-body text-center px-0 pb-0">
                            <h6 class="card-title text-muted m-0">Samosa</h6>
                        </div>
                    </div>
                </a>
            </div>
            <div class="col-3">
                <a href="search-list.html" class="text-decoration-none link-dark">
                    <div class="card border-0">
                        ...
                        <div class="card-body text-center px-0 pb-0">
                            <h6 class="card-title text-muted m-0">Healthy</h6>
                        </div>
                    </div>
                </a>
            </div>
            <div class="col-3">
                <a href="search-list.html" class="text-decoration-none link-dark">
                    <div class="card border-0">
                        ...
                        <div class="card-body text-center px-0 pb-0">
                            <h6 class="card-title text-muted m-0">Fries</h6>
                        </div>
                    </div>
                </a>
            </div>
        ...
        <div class="accordion" id="accordionExample">
            <div class="accordion-item border-0">
                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                    ...
                    <div class="accordion-body px-0 pb-0">
                        ...
                        <div class="row align-items-end">
                            <div class="col-3">
                                <div class="card border-0">
                                    <img src="img/d2.png" class="img-fluid m-auto ch-70" alt="#">
                                    <div class="card-body text-center px-0 pb-0">
                                        <h6 class="card-title text-muted m-0">Rolls</h6>
                                    </div>
                                </div>
                            ...
                            <div class="col-3">
                                <div class="card border-0">
                                    <img src="img/d6.png" class="img-fluid m-auto ch-70" alt="#">
                                    <div class="card-body text-center px-0 pb-0">
                                        <h6 class="card-title text-muted m-0">Chaat</h6>
                                    </div>
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="card border-0">
                                    <img src="img/d8.png" class="img-fluid m-auto ch-70" alt="#">
                                    <div class="card-body text-center px-0 pb-0">
                                        <h6 class="card-title text-muted m-0">Healthy</h6>
                                    </div>
                                </div>
                            ...
                            <div class="col-3">
                                <div class="card border-0">
                                    <img src="img/d7.png" class="img-fluid m-auto ch-70" alt="#">
                                    <div class="card-body text-center px-0 pb-0">
                                        <h6 class="card-title text-muted m-0">Fries</h6>
                                    </div>
                                </div>
                ...
                <h2 class="accordion-header" id="headingTwo">
                    <button class="btn-light bg-lgiht shadow-none w-100 border-0 btn mt-3 collapsed small" type="button"
        ...
        <div class="row gy-3">
                ...
                <a href="search-list.html" class="text-decoration-none link-dark">
                    <div class="card rounded-4 shadow border-0 overflow-hidden">
                        <div class="position-relative">
                            <div class="product-back"><img src="img/1.jpg" alt class="img-fluid rounded-top"></div>

                            <div class="product-time shadow-sm position-absolute bottom-0 end-0 m-3">
                                <span class="badge bg-light text-dark"><i
                                        class="fa-solid fa-stopwatch text-success"></i>&nbsp;37 mins | 2 km</span>
                            </div>

                            <div class="product-off bg-primary p-2 rounded-2 shadow-sm position-absolute top-0 end-0 m-3">
                                <div class="d-flex align-items-start gap-1 fw-bold text-white">
                                    <div><i class="fa-solid fa-percent fs-5"></i></div>
                                    <div>
                                        <div>50% OFF</div>
                                        <div class="fw-normal">Up to $100</div>
                                    </div>
                                </div>
                            </div>

                            <div class="position-absolute bottom-0 start-0 bg-danger p-1 rounded-end text-white mb-3">
                                <div class="fw-bold">Extra 15% OFF with Pro</div>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div class="h4 fw-bold">La Pino'z Pizza</div>
                        ...
                        <div class="card-footer p-3 border-0">
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="d-flex align-items-center gap-2">
                                    <div><img src="img/delivery.png" alt class="img-fluid ch-30"></div>
                                    <div class="text-muted small">Follows all Max Safety measures to<br> ensure your
                                        food
                                        id safe
                                    </div>
                                </div>
                                <div><img src="img/graph-up.png" alt class="img-fluid ch-30 cw-30"></div>
                            </div>
                        </div>
                    </div>
                </a>
                    ...
                    <div class="card rounded-4 shadow border-0 overflow-hidden">
                        <div class="position-relative">
                            <div class="product-veg bg-success  opacity-75 text-center text-white p-2"><span><i
                                        class="fa-brands fa-envira"></i></span>&nbsp;Pure Veg Resturant</div>
                            <div class="product-back-two"><img src="img/2.jpg" alt class="img-fluid rounded-top">
                            </div>

                            <div class="product-time shadow-sm position-absolute bottom-0 end-0 m-3">
                                <span class="badge bg-light text-dark"><i
                                        class="fa-solid fa-stopwatch text-success"></i>&nbsp;30 mins | 1 km</span>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div class="h4 fw-bold">La Pino'z Burger</div>
                                <div><span class="badge bg-success">4.0&nbsp;<i class="fa-solid fa-star"></i></span>
                                </div>
                            </div>
                            <div class="d-flex justify-content-between text-muted h6 m-0 fw-normal">
            ...
            <div class="col-12 col-md-4">
                <a href="search-list.html" class="text-decoration-none link-dark">
                    <div class="card rounded-4 shadow border-0 overflow-hidden">
                        <div class="position-relative">
                            <div class="product-back"><img src="img/3.jpg" alt class="img-fluid rounded-top"></div>

                            <div class="product-time shadow-sm position-absolute bottom-0 end-0 m-3">
                                <span class="badge bg-light text-dark"><i
                                        class="fa-solid fa-stopwatch text-success"></i>&nbsp;25 mins | 1.5 km</span>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div class="h4 fw-bold">Sharma Sweets And Fast Food</div>
                                <div><span class="badge bg-success">4.5&nbsp;<i class="fa-solid fa-star"></i></span>
                                </div>
                            </div>
                            <div class="d-flex justify-content-between text-muted h6 m-0 fw-normal">
                                <div>North India</div>
            ...
            <div class="col-12 col-md-4">
                <a href="search-list.html" class="text-decoration-none link-dark">
                    <div class="card rounded-4 shadow border-0 overflow-hidden">
                        <div class="position-relative">
                            <div class="product-back"><img src="img/4.jpg" alt class="img-fluid rounded-top"></div>

                            <div class="product-time shadow-sm position-absolute bottom-0 end-0 m-3">
                                <span class="badge bg-light text-dark"><i
                                        class="fa-solid fa-stopwatch text-success"></i>&nbsp;28 mins | 1 km</span>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div class="h4 fw-bold">Tibet Kitchen</div>
                                <div><span class="badge bg-success">4.5&nbsp;<i class="fa-solid fa-star"></i></span>
                                </div>
                            </div>
                            <div class="d-flex justify-content-between text-muted h6 m-0 fw-normal">
                        ...
                        <div class="card-footer p-3 border-0">
                            <div class="d-flex align-items-center gap-2">
                                <div><img src="img/graph-up.png" alt class="img-fluid ch-30 cw-30"></div>
                                <div class="text-muted">4300+ orders pplaced from here recently</div>
                            </div>
                        </div>
                    </div>
                </a>
            ...
            <div class="col-12 col-md-4">
                <a href="search-list.html" class="text-decoration-none link-dark">
                    <div class="card rounded-4 shadow border-0 overflow-hidden">
                        <div class="position-relative">
                            <div class="product-back"><img src="img/5.jpg" alt class="img-fluid rounded-top"></div>
                            ...
                            <div class="position-absolute bottom-0 start-0 bg-danger p-1 rounded-end text-white mb-3">
                                <div class="fw-bold">Extra 10% OFF with Pro</div>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div class="h4 fw-bold">Grill Masters</div>
                                <div><span class="badge bg-success">4.2&nbsp;<i class="fa-solid fa-star"></i></span>
                                </div>
                            </div>
                            <div class="d-flex justify-content-between text-muted h6 m-0 fw-normal">
                        ...
                        <div class="card-footer p-3 border-0">
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="d-flex align-items-center gap-2">
                                    <div><img src="img/graph-up.png" alt class="img-fluid ch-30 cw-30"></div>
                                    <div class="text-muted">2175+ orders pplaced from here recently</div>
                                </div>
                                <div><img src="img/delivery.png" alt class="img-fluid ch-30"></div>
                            </div>
                        </div>
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
            <div class="modal-content border-0">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">Add Your Location</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form>
                        <div class="input-group border rounded-3 mb-3 shadow-sm">
                            <span class="input-group-text bg-white border-0"><i class="bi bi-search"></i></span>
                            <input type="text" class="shadow-none form-control bg-white border-0 ps-0"
                                placeholder="bang">
                        </div>
                    </form>
                    <div data-bs-dismiss="modal" class="d-flex align-items-center gap-3 mb-3 px-0">
                        <div><i class="fa-solid fa-location-crosshairs text-danger"></i></div>
                        <div>Use Current Location</div>
                    </div>
                    <div class="text-muted text-uppercase small mb-1">Search Results</div>
                    <div data-bs-dismiss="modal" class="d-flex align-items-center gap-3 border-bottom py-3">
                        <span><i class="bi bi-search h6"></i></span>
                        <div class="lh-sm">
                            <h6 class="mb-1">Bangalore</h6>
                            <p class="text-muted m-0">Karnataka, India</p>
                        </div>
                    </div>
                    <div data-bs-dismiss="modal" class="d-flex align-items-center gap-3 border-bottom py-3">
                        <span><i class="bi bi-search h6"></i></span>
                        <div class="lh-sm">
                            <h6 class="mb-1">Bangalore internaltional airport</h6>
                            <p class="text-muted m-0">Karmpegowda.in't Airport, Hunachur, karnataka, India</p>
                        </div>
                    </div>
                    <div data-bs-dismiss="modal" class="d-flex align-items-center gap-3 border-bottom py-3">
                        <span><i class="bi bi-search h6"></i></span>
                        <div class="lh-sm">
                            <h6 class="mb-1">Railway Station back gate</h6>
                            <p class="text-muted m-0">M.G. Railway Colony, Majestic, Bangaluru</p>
                        </div>
                    </div>
                    <div data-bs-dismiss="modal" class="d-flex align-items-center gap-3 pt-3">
                        <span><i class="bi bi-search h6"></i></span>
                        <div class="lh-sm">
                            <h6 class="mb-1">Bangalore Cant</h6>
                            <p class="text-muted m-0">Cantonent Railway Station Road, Contonment Railway</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="modal fade" id="staticBackdrop2" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog  modal-dialog-centered">
            <div class="modal-content border-0">
                ...
                <div class="modal-body">
                    <div class="form-check d-flex justify-content-between mb-3 px-0 fs-6">
                    ...
                    <div class="form-check d-flex justify-content-between mb-0 px-0 fs-6">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-white text-danger" data-bs-dismiss="modal">Clear
                        All</button>
                    <button type="button" class="btn btn-danger rounded-md">Apply</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <nav id="main-nav">
        <ul class="second-nav">
            ...
            <li><a href="index-2.html"><i class="bi bi-house me-2"></i> Homepage</a></li>
            ...
            <li><a href="notification-setting.html"><i class="bi bi-bell-slash me-2"></i> Notification Setting</a>
            </li>
        ...
        <ul class="bottom-nav">
            <li class="email">
                <a class="text-danger nav-item text-center" href="index-2.html" tabindex="0">
    ...
    <!-- Mirrored from askbootstrap.com/preview/eatsome/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Sep 2023 03:05:09 GMT -->
@endsection()
