                    ...
                    <div class="col-md-4">
                            ...
                            <div class="ibox-content ibox-br">
                                ...
                                <form id="orderForm" enctype="multipart/form-data">
                                        ...
                                        <tbody id="cartContentsHtml">
                                            ...
                                            <tr>
                                                <td style="width:60%" class="cart-item">
                                                    {{ $details['name'] }}<br> <span class="text-menu-description text-muted"></span> </td>
                                    ...
                                    <div id="coupon_form" class="mb-2">
                                        <input type="text" placeholder="Coupon code" name="coupon_code" value="{{ session()->has('coupon') ? session()->get('coupon')['coupon_code'] : '' }}" id="coupon_code" class="form-control">
                                    ...
                                    <div class="form-group" id="txtOrderIsReady">
                                        <textarea class="form-control" name="note" maxlength="70" rows="2" placeholder="Indicate if you have a note for the order"></textarea>
                                    </div>
                                    <button type="button" id="placeOrder" onclick="submitOrder(<?= $tableId ?>)" class="btn btn-primary btn-outline btn-block mt-4 btn-sm"> Place the
                                        Order</button>
                                </form>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-6" style="padding-right:7px">
                                <button onclick="callTheWaiter(<?= $tableId ?>)" class="btn btn-primary btn-outline btn-block mt-4 btn-sm btn-block"><img src="{{ asset('request_service.svg') }}" /> </br><span> Gọi nhân
                                        viên</span></button>
                            </div>
                            <div class="col-6" style="padding-left:7px">
                                <button onclick="callPayment(<?= $tableId ?>)" class="btn btn-primary btn-outline btn-block mt-4 btn-sm btn-block"><img src="{{ asset('request_payment.svg') }}" /> </br><span> Gọi thanh
                                        toán</span></button>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="ibox">
                                ...
                                <div class="product-imitation" style="background-image:url('https://giadinh.mediacdn.vn/2021/1/2/photo-1-1609589680616478051930.jpg'); background-size:cover;">
                                </div>
                                ...
                                <div class="product-desc">
                                    ...
                                    <div class="m-t mx-auto">
                                        <div class="row">
                                            <input id="txtQuantity-{{ $product->id }}" class="product-quantity-input ml-3" value="1" max="99">
                                            <button onclick="addToCart({{ $product->id }})" class="btn btn-sm btn-outline btn-primary ml-1">
                                                Thêm
