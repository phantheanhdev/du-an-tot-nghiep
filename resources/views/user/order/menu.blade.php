...
>>>>>>> 9fc988a2c198966e5adabe5bda981543aa2aa56b
...
>>>>>>> 9fc988a2c198966e5adabe5bda981543aa2aa56b
                                        ...
                                        <tr>
                                            <td style="width:60%" class="cart-item">
                                                {{ $details['name'] }}<br> <span class="text-menu-description text-muted">fdf</span>
                                            </td>

<<<<<<< HEAD
                                            <td><input onblur="updateQuantity()" id="cartquantity-3" class="quantity-input" value="{{ $details['quantity'] }}"></td>

                                            <td style="width:28%;" class="cart-item">
                                                ${{ number_format($details['price']) }}</td>

                                            <td><a onclick="remove_product({{ $details['id'] }})" class="float-right"><i class="fa fa-times text-qrRestremove-from-cart"></i></a>
                                            </td>
                                        </tr>
                                        @endforeach
                                        @endif
                                ...
                                <button type="button" id="placeOrder" onclick="submitOrder(<?= $tableNo ?>)" class="btn btn-primary btn-outline btn-block mt-4 btn-sm"> Đặt món</button>
                                </form> --}}
                                <form id="orderForm" enctype="multipart/form-data">
                                    @csrf
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td rowspan="2" style="width: 78px; vertical-align: top;">
                                                                <div class="image__item-cart" style="background-image: url(&quot;/static/images/default_food.svg&quot;);">
                                                                </div>
                                                            </td>
                                                            <td class="td--product-name" style="vertical-align: top;"><span style="font-weight: 500; color: #910400; font-size: 14px;">{{ $details['quantity'] }}
                                                                    x</span> <span class="name" style="font-size: 14px; font-weight: 500;">{{ $details['name'] }}</span><br>
                                                                ...
                                                                <div class="price-and-edit-text__container" style="margin-top: 5px;">
                                                                    ...
                                                                    <div class="edit-text" style="color: rgb(247, 148, 30);">
                                                                        Chỉnh sửa
                                                                    </div>
                                                                </div>
...
>>>>>>> 9fc988a2c198966e5adabe5bda981543aa2aa56b
                        ...
                        <div class="row mb-3">
                            <div class="col-6" style="padding-right:7px">
                                <button onclick="callTheWaiter(<?= $tableNo ?>)" id="btnCallWaiter" class="call-button btn-block"><img src="{{ asset('upload_file/call-waiter.png') }}">
                                    Gọi Nhân Viên</button>
                            </div>
                            <div class="col-6" style="padding-left:7px">
                                <button onclick="callPayment(<?= $tableNo ?>)" id="btnCallBill" class="call-button btn-block"><img src="{{ asset('upload_file/get-money.png') }}">
                                    Thanh toán</button>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="ibox">
                                            ...
                                            <div class="product-imitation" style="background-image:url({{ Storage::url($product->image) }}); background-size:cover;">
                                            </div>
...
<<<<<<< HEAD
                                            <div class="product-desc">
                                                ...
                                                <a class="product-name" id="product-name-{{ $product->id }}">
                                                    {{ $product->name }}</a>
                                                ...
                                                <div class="m-t mx-auto">
                                                    <div class="row">
                                                        ...
                                                        <button class="btn btn-sm btn-outline btn-primary ml-1" data-toggle="modal" data-target="#exampleModalScrollable-product-{{ $product->id }}">
                                                            Thêm
                                                            <i class="fa fa-long-arrow-right mt-1"></i>
                                                        </button>
=======
...
>>>>>>> 9fc988a2c198966e5adabe5bda981543aa2aa56b
                                ...
                                @foreach ($products as $product)
                                <div class="modal fade" id="exampleModalScrollable-product-{{ $product->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
                                            ...
                                            <div class="row bg-danger">
                                                <div class="">
                                                    ...
                                                    <span class="" style="font-size: 20px;">
                                                        ...
                                                        đ
                                                        <input type="hidden" id="product-price-{{ $product->id }}" value="{{ $newPrice }}">
                                                    </span>
                                                    @else
                                                ...
                                                <div class="box col-md-12 mb-4">
                                                    ...
                                                    <div class="choose">
                                                        ...
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" name="variants_items[]" id="variants_item" value="{{ $variantItem->id }}" required>
                                                            <label class="form-check-label" for="exampleRadios1">
                                                                {{ $variantItem->name }}
                                                                :
                                                                <span class="text-danger">{{ number_format($variantItem->price) }}đ</span>
                                                            </label>
...
<<<<<<< HEAD
                                                        ...
                                                        @foreach ($variant->productVariantItems as $variantItem)
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox" name="variants_items[]" id="variants_item" value="{{ $variantItem->id }}">
                                            ...
                                            <div class="numbers-row">
                                                <input type="text" value="1" id="txtQuantity-{{ $product->id }}" class="qty2 form-control" name="quantity">
...
>>>>>>> 9fc988a2c198966e5adabe5bda981543aa2aa56b
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" onclick="addToCart({{ $product->id }})" class="btn btn-primary">Thêm</button>
